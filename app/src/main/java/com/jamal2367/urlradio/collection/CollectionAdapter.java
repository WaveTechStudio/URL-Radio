...
import com.jamal2367.urlradio.helpers.DialogAdd;
 ...
 */
public final class CollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements URLRadioKeys {
    ...
    /* Handles a playback state error that can occur when URLRadio crashes during playback */
    private void handlePlaybackStateError(Intent intent) {
        LogHelper.e(LOG_TAG, "Forcing a reload of station list. Did URLRadio crash?");
