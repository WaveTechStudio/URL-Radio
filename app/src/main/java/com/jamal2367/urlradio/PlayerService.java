...
import com.jamal2367.urlradio.helpers.AudioFocusAwarePlayer;
import com.jamal2367.urlradio.helpers.AudioFocusHelper;
import com.jamal2367.urlradio.helpers.AudioFocusRequestCompat;
import com.jamal2367.urlradio.helpers.LogHelper;
import com.jamal2367.urlradio.helpers.NotificationHelper;
import com.jamal2367.urlradio.helpers.PackageValidator;
import com.jamal2367.urlradio.helpers.StationListProvider;
...
import static com.jamal2367.urlradio.helpers.StationListProvider.MEDIA_ID_EMPTY_ROOT;
import static com.jamal2367.urlradio.helpers.StationListProvider.MEDIA_ID_ROOT;


/**
 * PlayerService class
 */
public final class PlayerService extends MediaBrowserServiceCompat implements URLRadioKeys, AudioFocusAwarePlayer, Player.EventListener, MetadataOutput, AnalyticsListener {
    ...
    public void onCreate() {
        ...
        mWifiLock = ((WifiManager) this.getSystemService(Context.WIFI_SERVICE)).createWifiLock(WifiManager.WIFI_MODE_FULL, "URLRadio:wifi_lock");
        PowerManager powerManager = (PowerManager) getSystemService(POWER_SERVICE);
        mWakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "URLRadio:wake_lock");
