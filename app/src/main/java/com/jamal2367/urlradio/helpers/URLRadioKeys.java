 ...
 * This interface hosts all keys used to control URLRadio's state
 *
 ...
 * URLRadioKeys class
 */
public interface URLRadioKeys {

    String APPLICATION_NAME = "URLRadio";

    /* ACTIONS */
    String ACTION_PLAY = "com.jamal2367.urlradio.action.PLAY";
    String ACTION_STOP = "com.jamal2367.urlradio.action.STOP";
    String ACTION_DISMISS = "com.jamal2367.urlradio.action.DISMISS";
    String ACTION_PLAYBACK_STATE_CHANGED = "com.jamal2367.urlradio.action.PLAYBACK_STATE_CHANGED";
    String ACTION_METADATA_CHANGED = "com.jamal2367.urlradio.action.METADATA_CHANGED";
    String ACTION_SHOW_PLAYER = "com.jamal2367.urlradio.action.SHOW_PLAYER";
    String ACTION_TIMER_RUNNING = "com.jamal2367.urlradio.action.TIMER_RUNNING";
    String ACTION_TIMER_START = "com.jamal2367.urlradio.action.TIMER_START";
    String ACTION_TIMER_STOP = "com.jamal2367.urlradio.action.TIMER_STOP";
